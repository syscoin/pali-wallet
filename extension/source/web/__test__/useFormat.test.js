...
const { ellipsis, formatCurrency, formatDistanceDate, formatNumber, formatURL } = require('../../hooks/useFormat')
...
describe('useFormat methods test', () => {
    ...
    it('should return a formatted distance date', () => {
        const formattedDate = formatDistanceDate(new Date(12 * 1000).toDateString()) 

...
// const Header: FC<IHeader> = ({ showLogo = false, backLink = '#', showName = true, importSeed = false, canGoBack = false  }) => {
...
const Header = ({ onlySection = false, accountHeader = false, normalHeader = true }) => {
  return (
    <div>
      {onlySection && (
        <Section />

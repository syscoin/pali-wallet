...
const TransferOwnership = () => {
  ...
  useEffect(() => {
    console.log('account conne mint spt', transferOwnershipData)
  }, []);
  ...
  const handleMessageTotransferOwnershipData = () => {
    controller.wallet.account.setDataFromPageToTransferOwnership({
      fee,
      rbf
    });
  ...
  //               <div className={styles.flex}>
  //                 <p>Amount</p>
  //                 <p>{transferOwnershipData?.amount}</p>
  //               </div>
  ...
  //               <div className={styles.flex}>
  //                 <p>Asset guid</p>
  //                 <p>{transferOwnershipData?.assetGuid}</p>
  //               </div>
  ...
  //                       theme="btn-outline-primary"
  //                       variant={styles.button}
  //                       onClick={handleMessageTotransferOwnershipData}
  //                       disabled={!fee}
  //                     >
  //                       Next
  //                     </Button>
  ...
  return (
    <div>
      <SiteTransaction
        callbackToSetDataFromWallet={controller.wallet.account.setDataFromPageToTransferOwnership}

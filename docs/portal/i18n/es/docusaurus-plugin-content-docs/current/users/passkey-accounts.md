...
Si se elimina el estado local de la billetera o se restaura la billetera, Pali puede recuperar cuentas inteligentes passkey desde el registro de fábrica on-chain y los logs de eventos. La recuperación aún necesita una assertion WebAuthn de la passkey relevante.

...
Сервис, управляемый институцией, который может предоставлять gas sponsorship, relay support или required co-authorization для passkey smart account execution.

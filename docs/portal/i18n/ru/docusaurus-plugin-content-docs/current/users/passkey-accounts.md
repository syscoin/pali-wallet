...
Если локальное состояние кошелька удалено или Pali установлен на новом устройстве, Pali может восстановить passkey smart accounts из on-chain factory registry и event logs. Любая установка Pali с доступом к тому же passkey credential может импортировать соответствующие deployed accounts после WebAuthn assertion.

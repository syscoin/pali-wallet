...
Pali smart account는 active validator module을 통해 transaction과 signing flow를 승인합니다. 사용자는 여전히 Pali에서 승인합니다. Validator가 passkey 기반이면 browser 또는 OS도 WebAuthn prompt를 표시합니다.

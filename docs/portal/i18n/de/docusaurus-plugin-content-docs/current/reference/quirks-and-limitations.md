...
- `wallet_getCallsStatus` gibt für nicht unterstützte Status-Lookups eine unbekannte Bundle-ID zurück.
- `wallet_showCallsStatus` ist eine No-op-Kompatibilitätsmethode.

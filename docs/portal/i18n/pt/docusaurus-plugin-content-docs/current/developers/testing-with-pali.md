...
Ela inclui fluxos de passkey da Pali, `wallet_createPasskeyAccount`, `wallet_sendCalls`, geração de lote de allowance ERC-20 e solicitações comuns de carteira.

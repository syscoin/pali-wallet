...
| `5710` | A chain do bundle EIP-5792 não tem RPC configurado na wallet (`wallet_getCallsStatus` / `wallet_showCallsStatus`). |
| `5720` | Id de bundle EIP-5792 duplicado fornecido pela dapp em `wallet_sendCalls`. |

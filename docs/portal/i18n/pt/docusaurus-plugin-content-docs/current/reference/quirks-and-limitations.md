...
- `wallet_getCallsStatus` está implementado; ids de bundle desconhecidos falham com o erro `5730`.
- `wallet_showCallsStatus` está implementado e mostra o status do batch em um popup da wallet.

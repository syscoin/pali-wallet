...
The current flow does not rely on a remote sponsor service. Pali deploys with a wallet-owned bootstrap validator, then installs the requested validator through an account execution when needed.

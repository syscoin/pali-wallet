    ...
    <Layout title="CREATE ACCOUNT" id="create-account-title">
      {address ? (
        ...
        >
          ...
          >
            <Input
              className="phrase-input px-4 py-2 w-80 text-sm bg-fields-input-primary border border-fields-input-border focus:border-fields-input-borderfocus rounded-full md:w-full md:max-w-md"

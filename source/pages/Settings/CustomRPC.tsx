...
import { INetwork } from 'state/wallet/types';
...
const CustomRPCView = () => {
  ...
  let selectedToEdit: INetwork | undefined;
  if (networkId) selectedToEdit = networks[networkId];
    ...
    <Layout title="CUSTOM RPC">
      <Form
        ...
        initialValues={{
          ...
          chainID: selectedToEdit ? selectedToEdit.id : '',
        }}
        onFinish={onSubmit}
        autoComplete="off"

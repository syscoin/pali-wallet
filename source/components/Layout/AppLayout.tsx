...
export const AppLayout: FC<IAppLayout> = ({ children }) => {
  ...
  const pageTitle = useMemo(() => {
    ...
    if (path === '/home/details') {
      ...
      if (locationState?.nftId && locationState?.nftAddress)
        return 'NFT DETAILS';
  ...
  return (
    <div
      className={`scrollbar-styled remove-scrollbar relative w-full min-w-popup max-h-popup min-h-popup text-brand-white ${bgColor} ${
